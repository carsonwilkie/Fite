                            ...
                            return (
                              <>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "6px" }}>
                                  <span style={{ fontSize: "17px", fontWeight: "900", color: "#4a6fa5", flexShrink: 0 }}>2</span>
                                  <input
                                    type="range"
                                    min={2}
                                    max={sliderMax}
                                  ...
                                  />
                                  <span style={{ fontSize: "17px", fontWeight: "900", color: "#4a6fa5", flexShrink: 0 }}>{sliderMax}</span>
                                </div>
