              ...
              {maxN < 2 ? (
                ...
                <>
                  ...
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 0 }}>
                    ...
                    <div style={{ width: 22, height: 180, position: "relative", flexShrink: 0, marginRight: 4 }}>
                      {[10, 8, 6, 4, 2].map(tick => (
                    ...
                    <div style={{ flex: 1, minWidth: 0, overflowX: "auto" }}>
                      <div style={{ position: "relative" }} onMouseLeave={() => { setHoveredBar(null); setTappedBar(null); }}>
                        ...
                        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 180, pointerEvents: "none", zIndex: 0 }}>
                          {[10, 8, 6, 4, 2].map(tick => (
                            <div key={tick} style={{ position: "absolute", left: 0, right: 0, top: `${(1 - tick / 10) * 180}px`, height: 1, background: C.border }} />
                          ))}
                        </div>
